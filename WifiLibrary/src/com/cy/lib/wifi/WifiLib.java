...
public class WifiLib {
	...
	private OnWifiBroadcastReceiveCallback wifiCbk;
	...
	private OnWifiBroadcastReceiveCallback innerWifiBroadcastReceiveCallback = new OnWifiBroadcastReceiveCallback() {
	...
	public void setOnWifiBroadcastReceiveCallback(
			OnWifiBroadcastReceiveCallback cbk) {
		this.wifiCbk = cbk;
	}
	...
	/**
	 * 开始扫描热点 </br> 若有结果则会在
	 * {@link OnWifiBroadcastReceiveCallback#onScanResultsAvailable()}
	 * 进行回调。</br> 若失败则会在{@link OnWifiBroadcastReceiveCallback#onScanFailed()}
	 * 方法中进行回调
	 * 
	 * @param periodMillis
	 *            扫描的周期时间，单位为毫秒
